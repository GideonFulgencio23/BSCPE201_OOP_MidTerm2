...
class Test {
	public static void main(final String[] args) {
		...
		do {
			...
			System.out.println("1. Append Employee(Add Employee)");
			System.out.println("2. Display all Employees(Show All Employees)");
			System.out.println("3. Update Employee");
			System.out.println("4. Remove Employee (Delete Employee)");
